...
export default function JWTDecoder() {
  ...
  const sampleJWT =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJleHAiOjE5MTYyMzkwMjJ9.VG-3QZb3K2gY3Z0X2Z0X2Z0X2Z0X2Z0X2Z0X2Z0';
        ...
        <div className="flex h-14 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className="hover:bg-accent rounded-lg border px-3 py-2 text-sm font-medium transition-colors"
            >
              Load Sample
            </motion.button>
          </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {token && (
                    <motion.span
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className={`ml-2 rounded-full px-2 py-0.5 text-xs font-medium ${decoded ? 'bg-green-500/10 text-green-600' : 'bg-red-500/10 text-red-600'}`}
                    >
              ...
              {decoded ? (
                <>
                  ...
                  <div className="bg-card overflow-hidden rounded-2xl border shadow-sm">
                    ...
                    <div className="p-4">
                      <pre className="bg-muted/50 overflow-x-auto rounded-xl p-4 font-mono text-sm">
                  ...
                  {/* Payload */}
                  <div className="bg-card flex-1 overflow-hidden rounded-2xl border shadow-sm">
                    <div className="bg-muted/30 flex items-center justify-between border-b px-4 py-3">
                      <div className="flex items-center gap-2">
                ...
                <div className="bg-card flex h-full items-center justify-center rounded-2xl border shadow-sm">
